package com.example.mall.mbg.model.Oms;
...
public class OmsOrder implements Serializable {
    @JsonProperty("omsOrderOperateHistory")
    private OmsOrderOperateHistory omsOrderOperateHistory;
    @JsonProperty("omsOrderItem")
    ...
    @JsonProperty("integrationAmount")
    ...
    @JsonProperty("deliverySn")

    @ApiModelProperty(value = "物流单号")
    private String deliverySn;
    @JsonProperty("autoConfirmDay")
    ...
    @JsonProperty("billReceiverPhone")

    @ApiModelProperty(value = "收票人电话")
    private String billReceiverPhone;
    @JsonProperty("billReceiverEmail")
    ...
    public OmsOrderOperateHistory getOmsOrderOperateHistory() {
        return omsOrderOperateHistory;
    }

    public void setOmsOrderOperateHistory(OmsOrderOperateHistory omsOrderOperateHistory) {
        this.omsOrderOperateHistory = omsOrderOperateHistory;
    }
